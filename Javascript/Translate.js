...

{
...

    {
        ...
        document.getElementById("translate10").innerHTML = 'Kjolberg School';

        document.getElementById("translate11").innerHTML = 'Kjolberg School is a school in Sellebakk owned by the state. <br>2012 - 2019';

        document.getElementById("translate12").innerHTML = 'Borge secondary school';

        document.getElementById("translate13").innerHTML = 'Borge secondary is a school in northern Sellebakk. <br>2019 - 2022';
...

    {
        ...
        document.getElementById("translate10").innerHTML = 'Kjølberg Skole';

        document.getElementById("translate11").innerHTML = 'Kjølberg Skole er en statseid skole i Sellebakk. <br>2012 - 2019';

        document.getElementById("translate12").innerHTML = 'Borge Ungdomskole';

        document.getElementById("translate13").innerHTML = 'Borge Ungdomskole er en skole i nordre Sellebakk. <br>2019 - 2022';
