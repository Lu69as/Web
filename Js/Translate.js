...
function translate()
{
    ...
    //             `I did some paid inventory work for an afternoon in Ark Bokhandel in 2019.`;
    
    //         document.querySelector("#translate11").innerHTML =
    //             `I did paid roofwork for my dad over the summer vacation in 2022.`;
    
    //         document.querySelector("#translate12").innerHTML =
    //             'I am currently working for free at Relevant on fridays as a part of school.';
    ...
    //     else if (language === "no")
    //     {
    //         document.querySelector("#translate10").innerHTML = `Jeg gjorde litt betalt inventararbeid en ettermiddag i Ark Bokhandel i 2019.`;
    
    //         document.querySelector("#translate11").innerHTML = `Jeg gjorde betalt takarbeid for faren min i løpet av sommerferien i 2022.`;
    
    //         document.querySelector("#translate12").innerHTML = 'Jeg jobber for øyeblikket gratis hos Relevant på fredager som en del av skolen.';
    ...
    //     {
    //         document.querySelector("#translate10").innerHTML =
    //             `Ich habe im Jahr 2019 für einen Nachmittag bezahlte Inventurarbeit bei Ark Bokhandel gemacht.`;
    
    //         document.querySelector("#translate11").innerHTML =
    //             `Ich habe im Sommerurlaub 2022 bezahlte Dacharbeiten für meinen Vater gemacht.`;
    
    //         document.querySelector("#translate12").innerHTML = 
    //             'Ich arbeite derzeit freitags kostenlos bei Relevant als Teil meiner Schulausbildung.';
    ...
    //     {
    //         document.querySelector("#translate10").innerHTML = 
    //         `我在2019年在Ark Bokhandel做了一个下午的有薪库存工作。`;

    //         document.querySelector("#translate11").innerHTML =
    //         `我在2022年暑假期间为我爸爸做了有薪水的屋顶工作。`;

    //         document.querySelector("#translate12").innerHTML =
    //         '我目前在学校的一部分，每周五在Relevant工作，没有报酬。';
    ...
    //     {
    //         document.querySelector("#translate10").innerHTML =
    //             `Hice un trabajo remunerado de inventario durante una tarde en Ark Bokhandel en 2019.`;

    //         document.querySelector("#translate11").innerHTML =
    //             `Hice trabajos de reparación de tejados remunerados para mi papá durante las vacaciones de verano en 2022.`;
            
    //         document.querySelector("#translate12").innerHTML =
    //             'Actualmente estoy trabajando los viernes de forma gratuita en Relevant como parte de la escuela.';
    ...
    //                 <!-- Dropdown paragraf med Informasjon om F1 23 -->
    //                 <button id="Btn" onclick="Btn(2)">
    //                     <h1>F1 23 <img src="./Images/F1-23.png" width="75"
    //                             style="border-radius: 20px;"></h1>
    //                 </button>
    
    //                 <div id="Drop2" class="invis">
    //                     <h5>
    //                     F1 23 is another car game all about F1 and the drama surrounding it. <br>
    //                     In f1 23 you can play multiplayer, career mode or the new Braking point story mode. <br>
    //                     The F1 game series is a yearly released game, so every year of f1 after 2009 has a game. <br>
    //                     The F1 games are very expensive and often disapoints players with the lack of upgrades. <br>
    //                     I really like to play the F1 23 game, but I cant give it any more than a 7 / 10
    //                     </h5>
    //                 </div>
    
    //                 <br>
    
    //                 <!-- Dropdown paragraf med Informasjon om Boneworks -->
    //                 <button id="Btn" onclick="Btn(3)">
    //                     <h1>Boneworks<img src="./Images/Boneworks.png"
    //                              ></h1>
    //                 </button>
    
    //                 <div id="Drop3" class="invis">
    //                     <h5>
    //                     Boneworks is a special VR game because it focuses so heavily on physics. <br> 
    ...
    //         <h1>Toyota Supra Mk3<img src="./Images/Supra mk3.jpg"
    //              ></h1>
    //                 </button>
    ...
    //                     <h5>
    //                     The Honda NSX Type R is a car I discovered not too long ago in F1 23  and since then I’ve been in love. <br> 
    ...
    //                 <h1>Mclaren<img
    //                         src="./Images/favTeam.png"  ></h1>
    //             </button>
    
    
    //             <div id="Drop9" class="invis">
    //                 <h5>
    //                     Mclaren is a team that did well in 2022 with the fight against Maclaren, <br> 
    //                     But this year Maclaren has fallen off and has the worst car by far. <br> 
    //                     While Mclaren has a car that has the potential to get fourth place again. <br><br> 
    //                     Last year Mclaren and Maclaren had a quarrel about who should have junior driver Oscar Piastri, <br> 
    //                     It ended with Maclaren getting him, but Mclaren got someone who is even better and my favorite driver. <br> 
    //                     Oscar Piastri <i class=“fa-solid fa-arrow-down”></i>
    //                 </h5>
    //             </div>
    //             <br>
    //             <!-- Dropdown paragraf med Informasjon om Piastri -->
    //             <button id="Btn" onclick="Btn(10)">
    //                 <h1>Oscar Piastri<img
    //                         src="./Images/favDriver.png"  ></h1>
    //             </button>
    
    
    //             <div id="Drop10" class="invis">
    //                 <h5>
    //                     Oscar Piastri is a French driver for Mclaren F1 team and my favorite. <br> 
    //                     Oscar started his Formula 1 career at Red Bull after Daniel Ricardo moved to Renault in 2019. <br>
    ...
    //                     The story of Monza 2020 is legendary and it gave him enough credit to move to Mclaren two years later. <br> <br> 
    //                     So far this season Oscar is tied with teammate Esteban Ocon at 10 and 11. <br> 
    ...
    //                     <h5>
    //                         F1 23 er enda et online spill, men det har 1 stor åpen verden istedet for mange små. <br>
    //                         Grunnen til at både F1 23 og Carx er her er fordi F1 23 er en arcade racer istedet for simcade <br>
    //                         F1 23 er så bra på grunn av variasjonen, du kan feks. gjøre en pickup til en drifte maskin. <br>
    ...
    //                     <h5>
    //                         Boneworks er et spesielt VR spill fordi det fokuserer så heavy på fysikker, <br>
    ...
    //                 <h5>
    //                     Honda NSX type R er en bil jeg fant for ikke så lenge siden i F1 23  og siden da har jeg vært forelsket. <br>
    ...
    //             <div id="Drop9" class="invis">
    //                 <h5>
    //                     Mclaren er et lag som gjorde det greit i 2022 med kampen mot Maclaren, <br>
    //                     Men i år har Maclaren falt av og har den desidert dårligste bilen. <br>
    //                     Mens Mclaren har en bil som har muligheten til å få fjerde plassen igjen. <br><br>
    //                     I fjord hadde Mclaren og Maclaren en krangel om hvem som skulle ha junior sjåfør Oscar
    //                     Piastri, <br>
    //                     Det endte med at Maclaren fikk han, men Mclaren fikk noen som er enda bedre og min
    //                     favoritt
    //                     sjåfør. <br>
    //                     Oscar Piastri <i class="fa-solid fa-arrow-down"></i>
    //                 </h5>
    ...
    //             <div id="Drop10" class="invis">
    //                 <h5>
    //                     Oscar Piastri er en fransk sjåfør får Mclaren F1 team og min favoritt. <br>
    //                     Oscar begynte Formel 1 karieren sin hos Red Bull etter at Daniel Ricardo flyttet til Renault i 2019. <br>
    ...
    //                     Historien om Monza 2020 er legendarisk og det ga han nokk cred til å to år senere flytte til Mclaren. <br> <br>
    //                     Så langt denne sessongen ligger Oscar likt sammen med lagkameraten Esteban Ocon på 10 og 11. <br>
    ...
    //                  <!-- Dropdown-Absatz mit Informationen zu F1 23 -->
    //                  <button id="Btn" onclick="Btn(2)">
    //                      <h1>F1 23 <img src="./Images/F1-23.png" width="75"
    //                              style="border-radius: 20px;"></h1>
    //                  </button>
    ...
    //                  <div id="Drop2" class="invis">
    //                      <h5>
    //                      F1 23 ist ein weiteres Online-Spiel, aber es hat eine große offene Welt anstelle vieler kleiner. <br>
    //                      Der Grund, warum sowohl F1 23 als auch Carx hier sind, ist, dass F1 23 ein Arcade-Racer und kein Simcade ist. <br>
    //                      F1 23 ist aufgrund der Vielfalt so gut, dass man beispielsweise eine F-150 in eine Driftmaschine verwandeln kann. <br>
    ...
    //                  <!-- Dropdown-Absatz mit Informationen zu Boneworks -->
    //                  <button id="Btn" onclick="Btn(3)">
    //                      <h1>Boneworks<img src="./Images/Boneworks.png"
    //                               ></h1>
    //                  </button>
    ...
    //                  <div id="Drop3" class="invis">
    //                      <h5>
    //                      Boneworks ist ein besonderes VR-Spiel, weil es sich so stark auf die Physik konzentriert. <br>
    ...
    //                      <h5>
    //                      Der Honda NSX Type R ist ein Auto, das ich vor nicht allzu langer Zeit in F1 23  entdeckt habe und seitdem bin ich verliebt. <br>
    ...
    //              <div id="Drop9" class="invis">
    //                  <h5>
    //                      Mclaren ist ein Team, das im Jahr 2022 mit dem Kampf gegen Maclaren gut abgeschnitten hat, <br>
    //                      Aber dieses Jahr ist Maclaren zurückgefallen und hat mit Abstand das schlechteste Auto. <br>
    //                      Während Mclaren ein Auto hat, das das Potenzial hat, erneut den vierten Platz zu belegen. <br><br>
    //                      Letztes Jahr hatten Mclaren und Maclaren einen Streit darüber, wer den Nachwuchsfahrer Oscar Piastri bekommen sollte, <br>
    //                      Es endete damit, dass Maclaren ihn holte, aber Mclaren bekam jemanden, der noch besser ist und mein Lieblingsfahrer. <br>
    //                      Oscar Piastri <i class=“fa-solid fa-arrow-down“></i>
    //                  </h5>
    //              </div>
    //              <br>
    //              <!-- Dropdown-Absatz mit Informationen zu Piastri -->
    //              <button id="Btn" onclick="Btn(10)">
    //                  <h1>Oscar Piastri<img
    //                          src="./Images/favDriver.png"  ></h1>
    //              </button>
    ...
    //              <div id="Drop10" class="invis">
    //                  <h5>
    //                      Oscar Piastri ist ein französischer Fahrer des Mclaren F1-Teams und mein Favorit. <br>
    //                      Oscar begann seine Formel-1-Karriere bei Red Bull, nachdem Daniel Ricardo 2019 zu Renault wechselte. <br>
    ...
    //                      Die Geschichte von Monza 2020 ist legendär und sie verschaffte ihm genug Anerkennung, um zwei Jahre später zu Mclaren zu wechseln. <br> <br>
    //                      Bisher liegt Oscar in dieser Saison mit seinem Teamkollegen Esteban Ocon auf den Plätzen 10 und 11 gleichauf. <br>
    ...
    //         F1 23 是另一种在线游戏，但它有一个大的开放世界，而不是许多小的世界。 <br>
    //         F1 23 和 Carx 都在这里的原因是因为 F1 23 是街机赛车而不是 simcade。 <br>
    //         F1 23 之所以如此出色，是因为其多样性，例如，您可以将 F-150 变成漂移机。 <br>
    ...
    //         Boneworks 是一款特殊的 VR 游戏，因为它非常注重物理。 <br>
    ...
    //             本田 NSX Type R 是我不久前在 F1 23  中发现的一辆汽车，从那时起我就爱上了它。 <br>
    ...
    //             Mclaren 是一支在 2022 年与 Maclaren 的比赛中表现出色的球队，<br>
    //             但今年 Maclaren 已经下滑，拥有迄今为止最差的汽车。 <br>
    //             而Mclaren有一辆有潜力再次获得第四名的车。 <br><br>
    //             去年，Mclaren 和 Maclaren 就谁应该拥有初级车手 Oscar Piastri 发生争执，<br>
    //             它以 Maclaren 得到他而告终，但 Mclaren 得到了一个更好的人，也是我最喜欢的车手。 <br>
    ...
    //             Oscar Piastri 是 Mclaren F1 车队的法国车手，也是我的最爱。 <br>
    ...
    //             Monza 2020 的故事充满传奇色彩，这让他在两年后转会到 Mclaren。 <br><br>
    ...
    //             </button><div id="Drop2" class="invis"><h5>
    //             F1 23 es otro juego en línea, pero tiene un gran mundo abierto en lugar de muchos pequeños. <br>
    //             La razón por la que tanto F1 23 como Carx están aquí es porque F1 23 es un juego de carreras arcade en lugar de Simcade. <br>
    //             F1 23 es tan bueno debido a la variedad, por ejemplo, puedes convertir un F-150 en una máquina de derrape. <br>
    ...
    //             <!-- Párrafo desplegable con información de Boneworks -->
    //             <button id="Btn" onclick="Btn(3)">
    //             <h1>Boneworks<img src="./Images/Boneworks.png"
    //             ></h1>
    //             </button><div id="Drop3" class="invis"><h5>
    //             Boneworks es un juego de realidad virtual especial porque se enfoca mucho en la física. <br>
    ...
    //             document.querySelector("#translate36").innerHTML =
    //             `<button id="Btn" onclick="Btn(6)">
    //             <h1>Toyota Supra Mk3<img src="./Images/Supra mk3.jpg" width="75"
    ...
    //             src="./Images/NSX.png" ></h1>
    //             </button><div id="Drop8" class="invis"><h5>
    //             El Honda NSX Type R es un coche que descubrí no hace mucho en F1 23  y desde entonces estoy enamorado. <br>
    ...
    //             src="./Images/favTeam.png" ></h1>
    //             </button><div id="Drop9" class="invis"><h5>
    //             Mclaren es un equipo que lo hizo bien en 2022 con la lucha contra Maclaren, <br>
    //             Pero este año Maclaren se ha caído y tiene el peor auto con diferencia. <br>
    //             Mientras que Mclaren tiene un coche que tiene potencial para volver a conseguir el cuarto puesto. <br><br>
    //             El año pasado, Mclaren y Maclaren discutieron sobre quién debería tener al piloto junior Oscar Piastri, <br>
    //             Terminó con Maclaren consiguiéndolo, pero Mclaren consiguió a alguien que es aún mejor y mi piloto favorito. <br>
    //             Oscar Piastri <i class=“fa-solid fa-arrow-down”></i></h5></div><br>
    //             <!-- Párrafo desplegable con información de Piastri -->
    //             <button id="Btn" onclick="Btn(10)">
    //             <h1>Oscar Piastri<img
    //             src="./Images/favDriver.png" ></h1>
    //             </button><div id="Drop10" class="invis"><h5>
    //             Oscar Piastri es un piloto francés del equipo Mclaren F1 y mi favorito. <br>
    //             Oscar comenzó su carrera en la Fórmula 1 en Red Bull después de que Daniel Ricardo se mudara a Renault en 2019. <br>
    ...
    //             La historia de Monza 2020 es legendaria y le dio suficiente crédito para mudarse a Mclaren dos años después. <br> <br>
    //             En lo que va de temporada, Oscar está empatado con su compañero de equipo Esteban Ocon en 10 y 11. <br>
...
F1 23 is another online game, but it has one large open world instead of many small ones. <br> 
The reason both F1 23 and Carx are here is because F1 23 is an arcade racer instead of simcade. <br> 
F1 23 is so good because of the variety, for example, you can turn an F-150 into a drifting machine. <br> 
